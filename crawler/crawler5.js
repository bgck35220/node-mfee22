...
(async () => {
  ...
  try {
    ...
    let queryStockName = await axios.get('https://www.twse.com.tw/zh/api/codeQuery', {
      params: {
        query: stockNo,
      },
    });
    ...
    let saveNameResult = await connection.execute('INSERT INTO stocks (id, name) VALUES (?, ?)', [stockNo, stockName]);
